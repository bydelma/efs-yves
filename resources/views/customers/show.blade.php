...
@section('content')
    ...
    <div class="container">
       ...
       <br>
       <br>
        <?php echo 'Total of Initial Portfolio Value $', $iportfolio = $iportfolio + $stotal + $itotal ?>
        <br>
        <?php echo 'Total of Current Portfolio Value $', $cportfolio = $cportfolio + $svalue + $ivalue ?>
